    ...
    try {
      ...
      if (error.response) {
        ...
        switch (error.response.status) {
          ...
          case 404:
            Toast.show({
              type: 'error',
              text1: 'Erro',
              text2: 'Usuário não encontrado. Por favor, verifique suas credenciais.',
            });
            break;
          default:
            Toast.show({
        ...
        Toast.show({
          type: 'error',
          text1: 'Erro',
          text2: 'Nenhuma resposta do servidor. Por favor, tente novamente mais tarde.',
        });
      } else {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.passwordContainer}>
        ...
        >
          <Icon name={secureTextEntry ? "visibility" : "visibility-off"} size={24} color="#888" />
        </TouchableOpacity>
      </View>
      <TouchableOpacity style={styles.button} onPress={handleLogin}>
        <Text style={styles.buttonText}>Entrar</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.buttonSecondary} onPress={() => navigation.navigate('CadastroUsuario')}>
